<!-- footer -->
<footer>
		<div class="footer-top-first" style="background-color: #fff">
			<div class="container py-md-5 py-sm-4 py-3">
				<!-- footer first section -->
				<h3 class="tittle-w3l text-left mb-lg-5 mb-sm-4 mb-3">
				<span >Gi</span>ới thiệu về chúng tôi

			<!-- //tittle heading -->
					<div class="row">
						<div class="col-lg-12 welcome-left">
							<p style="text-align: left;">
							Siêu thị điện máy, tiền thân là chuỗi Dienmay.com ra đời cuối 2010, là chuỗi bán lẻ các sản phẩm điện tử tiêu dùng (điện tử, điện lạnh và gia dụng), 
							hiện đang có thị phần số 1 tại Việt Nam (tính đến tháng 12/2019) với cửa hàng khai trương đầu tiên tại 561 Xô Viết Nghệ Tĩnh, Phường 26, Quận Bình Thạnh, Tp.HCM tháng 12/2010.<br><br>
							Electric Store vừa đánh dấu một chặng đường đáng chú ý khi công bố chính thức vượt mốc 1.000 siêu thị trong hành trình 10 năm của mình. 
							Phát triển thần tốc, trở thành hệ thống bán lẻ điện máy đầu tiên của Việt Nam phủ sóng 63/63 tỉnh thành, Điện máy XANH luôn dẫn đầu trong việc phục vụ khách hàng tốt nhất.
							</p>
						</div>
				...
				Siêu thị điện máy, tiền thân là chuỗi Dienmay.com ra đời cuối 2010, là chuỗi bán lẻ các sản phẩm điện tử tiêu dùng (điện tử, điện lạnh và gia dụng), 
				hiện đang có thị phần số 1 tại Việt Nam (tính đến tháng 12/2019) với cửa hàng khai trương đầu tiên tại 561 Xô Viết Nghệ Tĩnh, Phường 26, Quận Bình Thạnh, Tp.HCM tháng 12/2010.<br>
				<span><b>Electric Store</b> vừa đánh dấu một chặng đường đáng chú ý khi công bố chính thức vượt mốc 1.000 siêu thị trong hành trình 10 năm của mình. 
				Phát triển thần tốc, trở thành hệ thống bán lẻ điện máy đầu tiên của Việt Nam phủ sóng 63/63 tỉnh thành, Điện máy XANH luôn dẫn đầu trong việc phục vụ khách hàng tốt nhất.</span>
				</p> -->
				<!-- //footer first section -->
			...
			<div class="container py-md-5 py-sm-4 py-3">
				<div class="row footer-info w3-agileits-info">
					...
					<div class="col-md-3 col-sm-6 footer-grids mt-sm-0 mt-4">
						<h3 class="text-white font-weight-bold mb-3">Trợ giúp</h3>
						<ul>
							<li class="mb-3">
								<a href="#">Giới thiệu về chúng tôi</a>
							</li>
							<li class="mb-3">
								<a href="?quanly=lienhe">Liên hệ</a>
							</li>
							<li class="mb-3">
							...
							<li>
								<a href="privacy.html">Cấp phép</a>
							</li>
						</ul>
					</div>
					<div class="col-md-3 col-sm-6 footer-grids mt-md-0 mt-4">
						<h3 class="text-white font-weight-bold mb-3">Thông tin liên lạc</h3>
						<ul>
							<li class="mb-3">
								<i class="fas fa-map-marker"></i>Cổ nhuế - Bắc Từ Liêm - Hà Nội</li>
							<li class="mb-3">
								<i class="fas fa-mobile"></i> 333 222 3333 </li>
							<li class="mb-3">
								<i class="fas fa-phone"></i> (+84) 111 222 333 </li>
							<li class="mb-3">
					...
					<div class="col-md-3 col-sm-6 footer-grids w3l-agileits mt-md-0 mt-4">
						...
						<p class="mb-3">Miễn phí giao hàng cho đơn đặt hàng trên 1000$</p>
						...
						<div class="footer-grids  w3l-socialmk mt-3">
							<h3 class="text-white font-weight-bold mb-3">Kết nối với chúng tôi</h3>
							<div class="social">
								<ul>
									<li>
	...
	<div class="copy-right py-3">
		<div class="container">
			<p class="text-center text-white">© 2022 Electro Store. All rights reserved | Design by
				<a href="http://facebook.com/minhmin199"> MinhDeMo.</a>
			</p>
		</div>
	</div>
	<!-- //copyright -->